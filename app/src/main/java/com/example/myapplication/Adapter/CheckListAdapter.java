        ...
        holder.checkBox.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(Myconstants.FALSE_STRING.equals(show)){
                    ...
                    notifyDataSetChanged();
                    Toast toastMessadge = null;
                    if(toastMessadge!=null){
                        toastMessadge.cancel();
                    }
                    if(itemsList.get(position).getChecked()){
                        toastMessadge = Toast.makeText(context,"("+holder.checkBox.getText()+")packed",Toast.LENGTH_SHORT);

                    }else {
                        toastMessadge = Toast.makeText(context,"("+holder.checkBox.getText()+")Unpacked",Toast.LENGTH_SHORT);
                    }
                    toastMessadge.show();
                }
            }
            ...
            public void onClick(View view) {
                new AlertDialog.Builder(context)
                        ...
                        .setPositiveButton("Confirm", new DialogInterface.OnClickListener() {
                            ...
                            @Override
                            public void onClick(DialogInterface dialogInterface, int i) {
                                Toast.makeText(context, "bur", Toast.LENGTH_SHORT).show();
